...
class EventCardTimetableWeekDesktop extends StatefulWidget {
  ...
  const EventCardTimetableWeekDesktop({
    super.key,
  ...
  @override
  State<EventCardTimetableWeekDesktop> createState() => _EventCardState();
}

class _EventCardState extends State<EventCardTimetableWeekDesktop> with SingleTickerProviderStateMixin {
