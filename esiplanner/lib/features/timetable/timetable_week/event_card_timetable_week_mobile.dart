...
class EventCardTimetableWeekMobile extends StatefulWidget {
  ...
  const EventCardTimetableWeekMobile({
    super.key,
  ...
  @override
  State<EventCardTimetableWeekMobile> createState() => _EventCardState();
}

class _EventCardState extends State<EventCardTimetableWeekMobile> {
