...
class ViewSubjectsProfileScreen extends StatefulWidget {
  ...
  @override
  State<ViewSubjectsProfileScreen> createState() =>
      _ViewSubjectsProfileScreenState();
}
  ...
  Future<void> _loadUserSubjects() async {
    ...
    if (username != null) {
      ...
      if (response['success'] == true) {
        ...
        List<dynamic> detailedSubjects = await Future.wait(
          subjects.map((subject) async {
            ...
            if (subjectDetails.isNotEmpty &&
                subjectDetails.containsKey('name')) {
              return {
                'code': subject['code'],
        ...
        setState(() {
          errorMessage =
              response['message'] ??
              'No se pudo obtener la información de las asignaturas';
          isLoading = false;
        });
      }
    } else {
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        children: [
                                          Icon(
                                            Icons
                                                .book, // Icono para el nombre de la asignatura
                                            size: 24,
                                            color:
                                                isDarkMode
                                                  ...
                                                  (type) => Container(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Icon(
                                                          Icons
                                                              .group, // Icono para el tipo de grupo
                                                          color:
                                                              isDarkMode
                                                                  ? Colors
                                                                      .yellow
